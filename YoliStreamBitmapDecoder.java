 ...
 */
public class YoliStreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {

    private final YoliDownsampler downsampler;
    private final ArrayPool byteArrayPool;

    public YoliStreamBitmapDecoder(YoliDownsampler downsampler, ArrayPool byteArrayPool) {
