...
interface YoliImageReader {
    ...
    final class InputStreamImageReader implements YoliImageReader {
    ...
    final class ParcelFileDescriptorImageReader implements YoliImageReader {
        private final ArrayPool byteArrayPool;
        private final List<ImageHeaderParser> parsers;
        private final ParcelFileDescriptorRewinder dataRewinder;

        public ParcelFileDescriptorImageReader(
