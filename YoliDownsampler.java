 ...
 * BitmapFactory}.
 */
//public final class YoliDownsampler {
    ...
    public Resource<Bitmap> decode(
            ...
            throws IOException {
        return decode(
                new YoliImageReader.InputStreamImageReader(is, parsers, byteArrayPool),
                requestedWidth,
                requestedHeight,
                options,
                callbacks);
    ...
    public Resource<Bitmap> decode(
            ...
            throws IOException {
        return decode(
                new YoliImageReader.ParcelFileDescriptorImageReader(
...
//                optionsWithScaling,
     ...
     *
     * @param imageReader The {@link YoliImageReader} representing the image.
